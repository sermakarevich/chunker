...
class TestModelProfile:
    def test_has_required_fields(self):
        ...
        assert profile.context_budget_tokens == 10000
...
class TestChunkerConfig:
    def test_defaults(self):
        ...
        assert config.min_chunk_tokens == 400
        ...
        assert config.context_budget_tokens == 10000
    ...
    def test_from_model_unknown_uses_defaults(self):
        ...
        assert config.max_chunk_tokens == 2000  # default
    ...
    def test_from_model_with_overrides(self):
        ...
        assert config.max_chunk_tokens == 2000  # from profile
