...
run input="./output/the_pragmatic_programmer/the_pragmatic_programmer.txt" model="gemma4:latest" output="output/the_pragmatic_programmer":
    #!/usr/bin/env bash
    set -euo pipefail
    output_dir="{{ output }}"
...
run-fixture model="gemma4:latest":
    ...
    just run output/the_pragmatic_programmer/the_pragmatic_programmer.txt {{ model }}
